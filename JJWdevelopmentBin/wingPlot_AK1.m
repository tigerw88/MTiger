function H = wingPlot_AK1(volcname,catalog,mapdata,vlat,vlon,sta_lat,sta_lon,plat,plon,latann,longann,phi,r_km,max_depth)
...
plotm(vlat, vlon,'dk','MarkerFaceColor','w','MarkerSize',10); % plot the volcano; make ared triangle
