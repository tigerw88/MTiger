...
BSpecific = addGroup(BSpecific, 'Personal Discretionary', -1500, ...
    ...
    'Education', 'Charity', 'Shipping', 'Misc Items', 'Gift', 'Sports', ...
    'Vacation'});

BSpecific = addGroup(BSpecific, 'Gym', -100*12, {'Gym'});

BSpecific = addGroup(BSpecific, 'Housing', -(800*12), ...
    {'Mortgage & Rent', 'Utilities', 'Internet', 'Trash Service', 'Water'});

BSpecific = addGroup(BSpecific, 'Shopping', -4000, ...
    {'Shopping', 'Sporting Goods', 'Clothing', 'Bike Service Parts', ...
    'Home', 'Furnishings'});
...
BSpecific = addGroup(BSpecific, 'Other Income', 40000*0.009, {'Income', ...
